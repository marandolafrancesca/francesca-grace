...
/* ═══════════════════════════════════════════════════════════════
   ...
   Palette:
     --ivory:   #D6EDFD  (warm parchment)
     --cream:   #C8E4FB  (section fills)
  ...
  return(
    <div style={{borderBottom:"1px solid rgba(107,98,88,0.2)"}}>
      <button onClick={()=>setOpen(!open)} style={{
        ...
        <span style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:19,color:"#1A6B7A",lineHeight:1.4}}>{q}</span>
  ...
  return(
    <div style={{background:"#D6EDFD"}}>
      ...
      <section ref={heroRef} style={{
        ...
        {/* Solid color hero */}
        <div style={{position:"absolute",inset:0,background:"#D6EDFD",transform:`translateY(${parallax}px)`,}}/>
        ...
        <svg style={{position:"absolute",bottom:0,left:0,right:0,opacity:0.06}} viewBox="0 0 1440 200" preserveAspectRatio="none">
          <path d="M0,100 C360,160 1080,40 1440,100 L1440,200 L0,200 Z" fill="#D6EDFD"/>
          <path d="M0,130 C480,60 960,180 1440,130 L1440,200 L0,200 Z" fill="#D6EDFD" opacity="0.5"/>
        </svg>

        {/* Hero content */}
        <div style={{position:"relative",zIndex:1,height:"100%",display:"flex",flexDirection:"column",justifyContent:"center",padding:"clamp(80px,10vw,120px) clamp(20px,5vw,80px) 80px clamp(20px,5vw,160px)"}}>
          {/* Pre-headline */}
          <div style={{opacity:0,animation:"fadeSlideUp 1s cubic-bezier(.16,1,.3,1) 0.3s forwards",marginBottom:24}}>
            <div style={{display:"flex",alignItems:"center",gap:18}}>
              ...
              <span style={{fontSize:10,letterSpacing:"0.35em",textTransform:"uppercase",color:"#1A6B7A",fontWeight:600,fontSize:11}}>Food &amp; Travel Creator</span>
              <div style={{width:48,height:"1px",background:"rgba(26,107,122,0.3)"}}/>
            </div>
          </div>
          ...
          <div style={{opacity:0,animation:"fadeSlideUp 1s cubic-bezier(.16,1,.3,1) 1.0s forwards",marginTop:48,display:"flex",gap:16,alignItems:"center",flexWrap:"wrap"}}>
            <button onClick={()=>setPage("Work With Me")} style={{
              ...
              color:"#1A6B7A",
              fontSize:11,letterSpacing:"0.2em",fontWeight:600,textTransform:"uppercase",
            ...
            <button onClick={()=>setPage("Portfolio")} style={{
              padding:"14px 36px",
              background:"transparent",border:"2px solid rgba(26,107,122,0.5)",
              color:"#1A6B7A",
              fontSize:11,letterSpacing:"0.2em",fontWeight:600,textTransform:"uppercase",
        ...
        {/* ── iPhone Mockup ── */}
        <a href="https://www.instagram.com/frvncescagracee?igsh=MWg1dTJ2amNrdzgwbA%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="hero-phone" style={{textDecoration:"none",display:"block",position:"absolute",right:"clamp(40px,6vw,130px)",top:"50%",transform:"translateY(-50%) rotate(-3deg)",zIndex:2,animation:"floatPhone 5s ease-in-out infinite",cursor:"pointer"}}>
        <div style={{
          position:"relative",
          zIndex:2,
          pointerEvents:"all",
      ...
      {/* ── EDITORIAL INTRO ─────────────────────────────────── */}
      <section style={{background:"#D6EDFD",padding:"clamp(60px,8vw,140px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
      ...
      {/* ── FEATURED VIDEOS ─────────────────────────────────── */}
      <section style={{background:"#D6EDFD",padding:"clamp(60px,8vw,140px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)"}}>
            ...
            {FEATURED_VIDEOS.map((v,i)=>(
              <Appear key={i} delay={i*0.12}>
                <a href={v.url} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",display:"block"}}>
                  <div style={{
                    background:"#C8E4FB",overflow:"hidden",
                    ...
                    <div style={{padding:"16px 18px",display:"flex",justifyContent:"space-between",alignItems:"center",borderTop:"1px solid rgba(107,98,88,0.12)"}}>
                      <span style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"#1E8A9A",letterSpacing:"0.02em"}}>Watch on TikTok</span>
      ...
      <section style={{background:"#1A7A8A",padding:"120px 80px 110px 160px",overflow:"hidden",position:"relative"}}>
      ...
      {/* ── SERVICES ─────────────────────────────────────────── */}
      <section style={{background:"#C8E4FB",padding:"clamp(60px,8vw,140px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:2,background:"rgba(107,98,88,0.1)"}}>
            {SERVICES.map((s,i)=>(
              <Appear key={s.n} delay={i*0.1}>
                <div style={{
                  background:"#C8E4FB",padding:"48px 36px",
      ...
      {/* ── BRANDS ───────────────────────────────────────────── */}
      <section style={{background:"#D6EDFD",padding:"clamp(60px,8vw,120px) clamp(20px,5vw,80px) clamp(50px,8vw,100px) clamp(20px,5vw,160px)"}}>
        <div style={{maxWidth:1100}}>
          ...
          <Appear delay={0.1}>
            <div style={{display:"flex",flexWrap:"wrap",gap:10,justifyContent:"center"}}>
              {BRANDS.map((b,i)=>(
                <div key={i} style={{padding:"10px 20px",border:"1px solid rgba(107,98,88,0.18)",fontSize:12,color:"#6B6258",letterSpacing:"0.04em",transition:"all 0.3s",cursor:"default",fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16}}
      ...
      {/* ── CTA ──────────────────────────────────────────────── */}
      <section style={{background:"linear-gradient(150deg,#1A6B7A 0%,#145E6E 50%,#1A6B7A 100%)",padding:"clamp(60px,8vw,130px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
        ...
        <Appear style={{position:"relative",zIndex:1,maxWidth:680}}>
          ...
          <button onClick={()=>setPage("Contact")} style={{padding:"16px 52px",background:"#D6EDFD",color:"#1A6B7A",border:"none",fontSize:10,letterSpacing:"0.3em",textTransform:"uppercase",cursor:"pointer",fontWeight:600,transition:"all 0.4s",fontFamily:"inherit",boxShadow:"0 8px 36px rgba(0,0,0,0.25)"}}
            onMouseOver={e=>e.target.style.background="#C8E4FB"}
            onMouseOut={e=>e.target.style.background="#D6EDFD"}>
            Get In Touch
          </button>
        </Appear>
      </section>
...
function AboutPage({setPage}){
  return(
    <div style={{background:"#D6EDFD",paddingTop:0}}>
      {/* Header */}
      <div style={{background:"#1A7A8A",padding:"120px 80px 90px 160px",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:1100,padding:"100px 80px 120px 160px"}}>
        <div style={{display:"grid",gridTemplateColumns:"3fr 2fr",gap:"60px 80px",alignItems:"start"}} className="r-grid-collapse">
          ...
          <Appear delay={0.25}>
            <div>
              <div style={{background:"#C8E4FB",padding:28,marginBottom:16}}>
                ...
                {[
                  ...
                  <div key={i} style={{display:"flex",justifyContent:"space-between",padding:"10px 0",borderBottom:i<5?"1px solid rgba(107,98,88,0.12)":"none",alignItems:"center"}}>
                    <span style={{fontSize:14,color:"#555555",letterSpacing:"0.04em"}}>{a.k}</span>
                    <span style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:17,color:"#0A4A58"}}>{a.v}</span>
                  </div>
                ))}
              </div>
              <div style={{background:"#1A7A8A",padding:24,textAlign:"center"}}>
                <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:13,color:"rgba(255,255,255,0.8)",marginBottom:6,letterSpacing:"0.04em"}}>covering</div>
...
function PortfolioPage(){
  ...
  return(
    <div style={{background:"#D6EDFD"}}>
      <div style={{background:"#1A7A8A",padding:"clamp(80px,10vw,120px) clamp(20px,5vw,80px) 80px clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
        ...
        <Appear style={{position:"relative",zIndex:1}}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"rgba(255,255,255,0.8)",marginBottom:16}}>the work</div>
      ...
      {/* Filters */}
      <div style={{background:"#C8E4FB",borderBottom:"1px solid rgba(107,98,88,0.12)"}}>
            ...
            <a href={item.url} target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",display:"block"}}>
              <div style={{
                ...
                <div style={{padding:"20px 22px 24px",display:"flex",justifyContent:"space-between",alignItems:"flex-end"}}>
                  <div>
                    <div style={{fontSize:14,letterSpacing:"0.12em",color:"#0A5A6A",textTransform:"uppercase",marginBottom:7}}>{item.type} · {item.city}</div>
  ...
  return(
    <div style={{background:"#D6EDFD"}}>
      <div style={{background:"#1A7A8A",padding:"clamp(80px,10vw,120px) clamp(20px,5vw,80px) 80px clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
        ...
        <Appear style={{position:"relative",zIndex:1}}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"rgba(255,255,255,0.8)",marginBottom:16}}>by the numbers</div>
      ...
      <div style={{padding:"clamp(50px,6vw,80px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)",maxWidth:1100}}>
        {/* TikTok */}
        <Appear delay={0.1}>
          <div style={{background:"#C8E4FB",marginBottom:36,overflow:"hidden",boxShadow:"0 2px 20px rgba(28,47,56,0.06)"}}>
            <div style={{background:"rgba(28,47,56,0.06)",padding:"20px 28px",display:"flex",alignItems:"center",gap:14,borderBottom:"1px solid rgba(107,98,88,0.1)"}}>
              <div style={{width:36,height:36,borderRadius:"50%",background:"#1A7A8A",display:"flex",alignItems:"center",justifyContent:"center",fontSize:14,color:"#1A6B7A"}}>♪</div>
              <div>
        ...
        {/* Instagram */}
        <Appear delay={0.15}>
          <div style={{background:"#C8E4FB",marginBottom:60,overflow:"hidden",boxShadow:"0 2px 20px rgba(28,47,56,0.06)"}}>
            <div style={{background:"rgba(28,47,56,0.06)",padding:"20px 28px",display:"flex",alignItems:"center",gap:14,borderBottom:"1px solid rgba(107,98,88,0.1)"}}>
          ...
          <div style={{borderTop:"1px solid rgba(107,98,88,0.15)",paddingTop:56}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(220px,1fr))",gap:20}}>
              {[
                ...
                <div key={i} style={{padding:"28px 24px",border:"1px solid rgba(107,98,88,0.14)",background:"#C8E4FB"}}>
                  ...
                  <p style={{fontSize:16,color:"#333333",lineHeight:1.9,margin:0}}>{c.b}</p>
                </div>
              ))}
            </div>
          </div>
...
function WorkWithMePage({setPage}){
  return(
    <div style={{background:"#D6EDFD"}}>
      ...
      <div style={{padding:"clamp(50px,6vw,90px) clamp(20px,5vw,80px) clamp(60px,8vw,120px) clamp(20px,5vw,160px)",maxWidth:1100}}>
        <Appear>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:18,color:"#0A5A6A",marginBottom:40,letterSpacing:"0.04em"}}>services</div>
        </Appear>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(250px,1fr))",gap:20,marginBottom:100}}>
          {SERVICES.map((s,i)=>(
            <Appear key={s.n} delay={i*0.1}>
              <div style={{background:"#C8E4FB",padding:"40px 30px",borderTop:"2px solid rgba(61,99,112,0.2)",height:"100%",transition:"all 0.4s"}}
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:16,marginBottom:100}}>
          {[
            ...
            <Appear key={i} delay={i*0.09}>
              <div style={{background:"#C8E4FB",padding:"30px 22px"}}>
                ...
                <p style={{fontSize:16,color:"#333333",lineHeight:1.9,margin:0}}>{p.d}</p>
              </div>
            </Appear>
          ))}
        </div>
        ...
        <Appear delay={0.1}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:18,color:"#0A5A6A",marginBottom:32,letterSpacing:"0.04em"}}>frequently asked</div>
          {[
  ...
  return(
    <div style={{background:"#D6EDFD"}}>
      <div style={{background:"#1A7A8A",padding:"clamp(80px,10vw,120px) clamp(20px,5vw,80px) 80px clamp(20px,5vw,160px)",position:"relative",overflow:"hidden"}}>
        ...
        <Appear style={{position:"relative",zIndex:1}}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"rgba(255,255,255,0.8)",marginBottom:16}}>get in touch</div>
        ...
        <Appear delay={0.25}>
          <div style={{marginTop:64,paddingTop:48,borderTop:"1px solid rgba(107,98,88,0.12)",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:28}}>
            {[
              ...
              <div key={c.l}>
                <div style={{fontSize:12,letterSpacing:"0.18em",textTransform:"uppercase",color:"#0A5A6A",marginBottom:8,fontWeight:700}}>{c.l}</div>
                {c.h?<a href={c.h} target="_blank" rel="noopener noreferrer" style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"#1E8A9A",textDecoration:"none"}}>{c.v}</a>
                    :<div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic",fontSize:16,color:"#6B6258",opacity:0.8}}>{c.v}</div>}
              </div>
            ))}
          </div>
        </Appear>
    ...
    <div>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        body{background:#D6EDFD;-webkit-font-smoothing:antialiased;font-family:'Cormorant Garamond',Georgia,serif;}
        ...
        select option{background:#C8E4FB;color:#1A6B7A;font-family:'Cormorant Garamond',Georgia,serif;}
        ::-webkit-scrollbar{width:3px;}
        ::-webkit-scrollbar-track{background:#D6EDFD;}
        ...
        @media(max-width:768px){
          .hero-content{padding:80px 24px 60px 24px!important;}
        ...
        /* ── MOBILE STYLES ── */
        @media(max-width:768px){
          :root{--main-margin:0px;}
          nav{width:100%!important;height:auto!important;flex-direction:row!important;
              padding:14px 20px!important;justify-content:space-between!important;
              bottom:auto!important;border-right:none!important;
              border-bottom:1px solid rgba(26,107,122,0.15)!important;
              background:rgba(209,246,255,0.97)!important;z-index:500!important;}
          nav > div:first-child{display:flex!important;align-items:center!important;}
          nav > div:nth-child(2){display:none!important;}
          nav > div:last-child{display:none!important;}
          main{margin-left:0!important;padding-top:0!important;}
          section{padding:60px 20px!important;}
          h1,h2{font-size:clamp(32px,8vw,60px)!important;}
          .r-grid-collapse{grid-template-columns:1fr!important;gap:40px!important;}
          .hero-phone{right:10px!important;width:140px!important;}
          .hero-phone > div{width:140px!important;height:290px!important;}
        }
      `}</style>
      ...
      <nav style={{
        ...
        padding:"40px 24px",
        background:isHero?"rgba(214,237,253,0.3)":"rgba(214,237,253,0.97)",
        backdropFilter:isHero?"none":"blur(20px)",
        borderRight:"1px solid rgba(26,107,122,0.15)",
        ...
        <div style={{display:"flex",flexDirection:"column",gap:4}}>
          {NAV_LINKS.map(l=>(
            <button key={l} onClick={()=>setPage(l)} style={{
              ...
              fontFamily:"inherit",
              fontSize:15,letterSpacing:"0.1em",textTransform:"uppercase",fontWeight:600,
              color:page===l
                ?(isHero?"#0A4A58":"#0A4A58")
                :(isHero?"#0A4A58":"#333333"),
              transition:"color 0.3s",
              position:"relative",
            }}
              onMouseOver={e=>e.target.style.color="#145E6E"}
              onMouseOut={e=>{e.target.style.color=page===l?"#1A6B7A":"#444444";}}
            >
              {l}
            </button>
          ))}
      ...
      {/* ── MAIN CONTENT ─────────────────────────────────────── */}
      <main style={{marginLeft:"var(--main-margin,130px)"}}>{pages[page]}</main>

      {/* ── FOOTER ───────────────────────────────────────────── */}
      <footer style={{marginLeft:130,background:"#1A7A8A",padding:"56px clamp(20px,5vw,80px) 40px clamp(20px,5vw,80px)",borderTop:"1px solid rgba(61,99,112,0.25)"}}>
